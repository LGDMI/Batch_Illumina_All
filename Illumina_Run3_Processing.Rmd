...
#Remove VCE2, sample not reliable
#abund_table<-abund_table[!rownames(abund_table) %in% c("Day082_Sulphate_c"),]
...
write.csv(df,file=paste("Sink_data/HillNumbers_bacteria_otu.csv",spe=""))
